      ...
      <div className="px-6 mx-auto mt-24 sm:mt-32 lg:mt-40 max-w-7xl">
        ...
        <div className="mt-8 space-y-6">
          ...
          <p className="max-w-4xl text-lg leading-relaxed text-gray-600">
            We are building more than just a club we are creating a <span className="font-semibold text-orange-600">movement</span> that
        ...
        <div className="lg:flex lg:items-start lg:gap-12">
          ...
          <div className="flex justify-center lg:w-1/2">
            <div className="w-full max-w-2xl">
              ...
              {/* Call to Action */}
              <div className="p-8 mt-8 text-white shadow-xl bg-gradient-to-r from-orange-500 to-yellow-500 rounded-2xl">
