      ...
      <div className="px-6 mx-auto mt-24 sm:mt-32 lg:mt-40 max-w-7xl">
        ...
        <div className="mt-8 space-y-6">
          ...
          <p className="max-w-4xl text-lg leading-relaxed text-gray-600">
            We are building more than just a club we are creating a <span className="font-semibold text-yellow-600">movement</span> that
      ...
      <div className="px-6 mx-auto mt-16 max-w-7xl">
        ...
        <div className="grid grid-cols-2 gap-6 mb-20 md:grid-cols-4">
          {[
            ...
            <div
              key={index}
              className="p-6 text-center transition-shadow duration-300 bg-white border-t-4 border-yellow-400 shadow-lg rounded-xl hover:shadow-xl"
            >
            ...
            <ul className="space-y-6">
              {visionPoints.map((point, index) => (
                <li
                  ...
                  className="relative p-6 overflow-hidden transition-all duration-300 bg-white border-l-4 border-yellow-400 shadow-md cursor-pointer group rounded-2xl hover:shadow-2xl hover:border-l-8 hover:-translate-y-1"
                >
