...
const renderTeamSection = (sectionTitle, members) => (
  <>
    <h2 className="text-3xl font-bold text-center mt-10 text-neutral-950">
      {sectionTitle}
    </h2>
...
const TeamPage = () => {
  return (
    <>
      <Head>
        <title>Meet Our Team | E-Cell SVNIT</title>
        <meta
          name="description"
          content="Meet the dedicated team members of E-Cell SVNIT. Connect with us on LinkedIn and Instagram."
        />
        <link rel="canonical" href="https://ecellsvnit.com/team" />
      </Head>
      <PageIntro eyebrow="Team" title="Meet Our Team" centered>
        <p>
          Get to know the amazing team behind E-Cell SVNIT. Connect with us on
