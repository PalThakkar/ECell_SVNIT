...
import { Rocket, Mail, Send, UserPlus, Instagram, Calendar, Sparkles, MessageSquare, User, Phone } from "lucide-react";
    ...
    <>
      ...
      <Container className="mt-16 sm:mt-20">
        ...
        <motion.section
          ...
          className="mb-20"
        >
          <div className="relative bg-gradient-to-br from-yellow-50 via-white to-orange-50 rounded-3xl p-8 md:p-12 border-2 border-yellow-200 shadow-xl overflow-hidden" style={{ backgroundColor: 'transparent' }}>
            {/* Decorative elements */}
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-3xl md:text-4xl font-bold !text-neutral-900" style={{ color: '#171717' }}>
                  Tell Us About Your <span className="text-yellow-600">Project</span>
                </h2>
              </div>
              
              <p className="!text-neutral-700 mb-8 text-lg max-w-3xl" style={{ color: '#404040' }}>
              ...
              <form onSubmit={handleProjectSubmit} className="grid md:grid-cols-2 gap-6">
                <div className="group">
                  <label className="block text-sm font-semibold !text-neutral-700 mb-2" style={{ color: '#404040' }}>
                    Your Name
                  </label>
        ...
        >
          <div className="grid lg:grid-cols-2 gap-10 items-start">
            {/* Query Form */}
            <div className="!bg-white rounded-3xl p-8 border-2 border-neutral-200 shadow-xl" style={{ backgroundColor: '#ffffff' }}>
              <div className="flex items-center gap-3 mb-6">
                <div className="p-3 bg-neutral-900 rounded-xl">
                  <MessageSquare className="w-7 h-7 text-white" strokeWidth={2.5} />
                </div>
                <h2 className="text-3xl font-bold !text-neutral-900" style={{ color: '#171717' }}>
                  Have a <span className="!text-neutral-900" style={{ color: '#171717' }}>Query?</span>
                </h2>
              </div>
        ...
        <motion.section
          ...
          className="mb-16"
        >
          <div className="relative !bg-white rounded-3xl p-10 md:p-16 border-2 border-yellow-400 shadow-2xl overflow-hidden" style={{ backgroundColor: '#ffffff' }}>
            ...
            <div className="relative z-10 text-center max-w-4xl mx-auto">
              ...
              <h2 className="text-4xl md:text-5xl font-black !text-neutral-900 mb-6" style={{ color: '#171717' }}>
                Join the <span className="text-yellow-600">E-Cell Family!</span>
              </h2>

              <p className="text-xl md:text-2xl !text-neutral-700 mb-8 leading-relaxed" style={{ color: '#404040' }}>
                Every year in <span className="font-bold text-yellow-600">June-July</span>, we recruit passionate 2nd-year students to join our incredible team. 
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                ...
                <div className="flex items-center gap-2 px-6 py-3 bg-neutral-100 rounded-full border-2 border-neutral-300">
                  ...
                  <span className="font-semibold !text-neutral-900" style={{ color: '#171717' }}>Stay Tuned!</span>
                </div>
              </div>

              <div className="mt-10 p-6 bg-yellow-50 rounded-2xl border-2 border-yellow-200">
                <p className="text-sm md:text-base !text-neutral-700" style={{ color: '#404040' }}>
                  <span className="font-bold text-yellow-600">Pro Tip:</span> Follow our Instagram for updates on recruitment drives, 
